...
from app.crud import tipo_veiculo
...
def test_create_tipo_veiculo_tarifa_negativa():
    ...
    with pytest.raises(ValueError, match="A tarifa por hora não pode ser negativa."):
        tipo_veiculo.create_tipo_veiculo(db=db_mock, tipo_veiculo=tipo_veiculo_negativo)
...
def test_create_tipo_veiculo_tarifa_valida():
    ...
    tipo_veiculo.create_tipo_veiculo(db=db_mock, tipo_veiculo=tipo_veiculo_valido)
...
def test_update_tipo_veiculo_tarifa_negativa():
    ...
    with pytest.raises(ValueError, match="A tarifa por hora não pode ser negativa."):
        tipo_veiculo.update_tipo_veiculo(db=db_mock, db_tipo_veiculo=db_tipo_veiculo_mock, tipo_veiculo=tipo_veiculo_update_negativo)